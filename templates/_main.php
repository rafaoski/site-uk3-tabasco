...
<link rel="icon" href="<?=setting('favicon')->url?>"/>
<?php endif;
...
style='background: linear-gradient( rgba(51, 12, 12, 0.87), rgba(2, 35, 50, 0.96) ),
url("<?php if($image) echo $image->url;?>") no-repeat center center fixed; background-size: <?=$background_size?>; height: 100%;'>
	...
	<header class='uk-navbar-transparent'>
		...
		<div id="modal-info-close" data-uk-modal>
				<div class="uk-modal-dialog uk-modal-body" style='background: #342f2f;'>
						<!-- <button class="uk-modal-info-close" type="button" data-uk-close></button> -->
		...
		<div id='masthead' class="uk-container">
			<h3 id='masthead-logo' class='uk-text-center uk-margin-medium-top uk-margin-small-bottom'>
				<a class='uk-text-center uk-text-uppercase hover uk-link-reset not-hover' href='<?=urls()->root?>'>
					<img class='svg-lighten' src='<?=setting('logo') ? setting('logo')->url : '';?>' alt='<?=setting('site-name')?>'><br>
					<span class='site-title'><?=setting('site-name')?></span>
				</a>
			</h3>
			<p id='masthead-tagline' class='uk-text-center uk-text-muted uk-h2 uk-margin-small uk-text-uppercase'>
		...
		<div id='footer' class='uk-container'>
			...
			<div data-uk-grid>
				...
				<div class='uk-width-2-3@m uk-flex-first@m uk-text-center uk-text-left@m'>
					<h3 class='uk-margin-remove uk-link-reset'>
						<a href="<?=setting('home')->url?>" class='uk-buton uk-button-text uk-text-uppercase'>
							<?=setting('site-name')?>
						</a>
					...
					<p class='uk-margin-remove uk-link-reset'>
						...
						<a class='uk-buton uk-button-text' href='<?=pages('options')->copyright->url_1?>'>
